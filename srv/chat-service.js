...
4. Keep the answers concise and truthful. 

Team Member Leave Schedule in system is as below:
`
;
    ...
    this.on('getChatRagResponse', async (req) => {
        try {
            ...
            if (category === "leave-request-query")
            {
                ...
                let teamLeaveDataString = JSON.stringify(teamLeaveDates);
                if(teamLeaveDataString == '{}') {
                    teamLeaveDataString = teamLeaveDataString + '\n None of team members are on leave.' 
                } else {
                    teamLeaveDataString = teamLeaveDataString + '\n Some of team members are on leave.'
                }
